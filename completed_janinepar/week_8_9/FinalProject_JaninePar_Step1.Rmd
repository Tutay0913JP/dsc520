...
1. Identify the current statistics on homelessness in America and focus on the Top state with homeless population.
1. Compare these variables between states with highest and lowest homeless population
1. Identify factors and variables that influence the decline in homelessness population
1. What are the main factors and variables that influence the increase of homelessness?
